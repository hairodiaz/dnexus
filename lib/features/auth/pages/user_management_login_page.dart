...
/// Pantalla de login para Gestión de Usuarios (Tema Cian/Teal)
/// Accedida únicamente con Ctrl+ArrowDown+ArrowUp desde SystemSelectionPage
class UserManagementLoginPage extends StatefulWidget {
  const UserManagementLoginPage({super.key});

  @override
  State<UserManagementLoginPage> createState() => _UserManagementLoginPageState();
}

class _UserManagementLoginPageState extends State<UserManagementLoginPage> {
